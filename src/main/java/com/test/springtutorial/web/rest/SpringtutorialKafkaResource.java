...
@RestController
@RequestMapping("/api/springtutorial-kafka")
public class SpringtutorialKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SpringtutorialKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SpringtutorialKafkaResource(KafkaProperties kafkaProperties) {
